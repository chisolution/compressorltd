    ...
    <script>
        $(document).ready(function() {
            ...
            $('#name').on('input', function() {
                ...
                // Only update slug if it matches the original or has been auto-generated
                if (slugInput.val() === originalSlug || slugInput.data('auto-generated')) {
